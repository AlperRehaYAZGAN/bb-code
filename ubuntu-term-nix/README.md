...
This is the ubuntu-term-nix image. It is based on the ubuntu:22.04 image and has the ttyd installed. It is used to run the terminal in the browser.
...
# run
docker run --privileged -it --rm -p 40020:40020 --name=bb-ubuntu22.04-term-nix-1.0.0 alperreha/bb-ubuntu:22.04-term-nix-v1.0.0
```
